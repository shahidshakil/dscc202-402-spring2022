...
for p in parameters:
    assert best_rf.get_params()[p] == model.get_params()[p], "'{}' does not match with the best model".format(p)
    print("'{}': {}  -->  matches with the best model".format(p, model.get_params()[p]))
